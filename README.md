...
Content
1787725745095_banking_features.csv

CSV

**# Business Understanding** **## Finance Customer Risk & Profitability Analytics** **---** **## 1. Project Title** **\*\*Finance Customer Risk & Profitability Analytics\*\*** **## 2. Business Domain** Banking / Consumer Finance **## 3. Role** Data Analyst **## 4. Tools**

PASTED

1787725666175_06_value_risk_analysis.sql

252 lines

SQL

1787725666176_01_basic_portfolio_analysis.sql

137 lines

SQL

1787725666177_02_account_transaction_analysis.sql

117 lines

SQL

1787725666177_03_loan_credit_analysis.sql

153 lines

SQL

1787725666178_04_customer_value_analysis.sql

131 lines

SQL

1787725666179_05_customer_metrics.sql

109 lines

SQL

1787725712858_feature_engineering.py

457 lines

PY

1787725712859_data_cleaning.py

552 lines

PY

1787725712859_data_inspection.py

479 lines

PY

1787725712860_data_quality_check.py

588 lines

PY

1787725712860_eda.py

715 lines

PY

Absolutely. Since your **Python and SQL analysis are already completed**, the `Business Insights & Recommendations` file should be a **final interpretation document**, not another analysis. ## 1. Create the file Inside your project: ```text Finance_Customer_Risk_Analytics/ │ ├── data/ ├
